...
<body>
	...
	<section id="main" class="column">
            <br />
            <header><h3><?php echo $nombretema ?></h3></header>
            <article class="module width_full">
                <header><h3>Agregar preguntas</h3></header>
                <form action="<?php echo base_url(); ?>index.php/pregunta/insertar_pregunta" method="post">                    
                    <div class="module_content">                         
                       <fieldset style="width:99%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
                            <label>Pregunta</label>
                            <?php echo form_error('nombrepregunta'); ?>
                            <input type="text" id="nombrepregunta" name="nombrepregunta" style="width:97%;" />
