						  ...
						  <tbody>							
							<?php foreach($tema_expo as $tema){ ?>
                                                        <tr>  
                                                            ...
                                                            <!--<td>Activo</td>-->
                                                            <td class="center">
                                                                <form action="<?php echo $url;?>/index.php/consulta/mostrar_consultas_tema" method="post">
                                                                ...
                                                                <form action="<?php echo $url;?>/index.php/pregunta/mostrar_preguntas_tema" method="post">
                                                                    <input type="hidden" id="idtema" name="idtema" value="<?php echo $tema->nro;?>" />                                                               
