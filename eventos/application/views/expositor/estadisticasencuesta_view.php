			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>Resultados de encuesta del evento <?php echo $nombreevento; ?></h2>
						<div class="box-icon">
					...
					<div class="box span5">
                                                ...
                                                <div class="box-content">
                                                       <img src="<?php echo base_url(); ?>index.php/encuesta/mostrar_grafico_encuesta/<?php echo $idevento; ?>" />
                                                </div>
                                        </div>
                                    <div class="box span6">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-th"></i>Encuesta</h2>
						<div class="box-icon">
                                                    <a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
                                                    <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                                                    <a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>                                                        
					...
					<div class="box-content">
                                            <div class="well">
                                                  <?php foreach ($encuesta as $enc) 
                                                        { ?>
                                                        <h3><?php echo $enc->idencuesta . '. ' . $enc->nombre; ?></h3>
                                                  <?php } ?>
                                                        <ol>
                                                  <?php for($i = 0; $i < count($opciones); $i++)
                                                        { ?>
                                                            <li><?php echo $opciones[$i]; ?></li>
                                                  <?php } ?>                                         
                                                        </ol>  
                                            </div>   
