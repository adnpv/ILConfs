    ...
    <body>
        <header id="header">
            <hgroup>
                ...
                <h2 class="section_title">Encuestas</h2>
            </hgroup>
        ...
        <section id="secondary_bar">
            ...
            <div class="breadcrumbs_container">
                <article class="breadcrumbs">
                    ...
                    <a class="current">Lista de encuestas</a>
                </article>
            </div>
        ...
        <header>
            ...
            <h3 class="tabs_involved">Encuestas</h3>
        </div>              
        ...
        <div class="tab_container" style="margin: 0 auto;">
            <div id="tab1" class="tab_content">
                <table class="tablesorter" cellspacing="0"> 
                    ...
                    <tbody> 
                  <?php foreach($preguntas_encta as $encta)
                        { ?>
                        <tr>  
                            <td></td>
                            <td><?php echo $encta->idencuesta; ?></td> 
                            <td><?php echo $encta->nombre; ?></td>                                              
                            <td>
                                <form action="<?php echo base_url(); ?>index.php/encuesta/mostrar_preguntas_encuesta" method="post">
                                    <input type="hidden" id="idevento" name="idevento" value="<?php echo $encta->idencuesta;?>" /> 
                                    <input type="hidden" id="nombreevento" name="nombreevento" value="<?php echo $encta->nombre;?>" />   
