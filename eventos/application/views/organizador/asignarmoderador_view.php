	 ...
	 <aside id="sidebar" class="column">
        ...
        <section id="main" class="column">
            ...
            <article class="module width_full">
                <header><h3>Asignar moderador</h3></header>
                <form method="get" action="<?php echo base_url(); ?>index.php/evento/asignar_mod">
                ...
                <footer>
                   <div class="submit_link" style="padding: 3px 340px;">                                               
                        <ul id="ulrdbtn">
                            <li><input type="submit" value="Asignar" class="alt_btn"></li>
                            <li>&nbsp;</li>
                            <li>&nbsp;</li>
